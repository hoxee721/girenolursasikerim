...
exports.run = async (client, message, args) => {
  ...
  .setAuthor('MC-EŞŞEK BOT', client.user.avatarURL)
  .setTitle('MC-EŞŞEK BOT', client.user.avatarURL)
  .setURL("https://discord.gg/DH9TKk4")
  .setDescription("!sunucutanıt Kullandınız.")
  .addField('Sizin Sunucunuz Burada Tanıtıldı', `[Tıkla](https://discord.gg/DH9TKk4)`)
        .setTimestamp()
